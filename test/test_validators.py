...
class TestValidators(unittest.TestCase):
    def test_interval(self):
        ...
        self.assertTrue(interval('1999-12-31T16:00:00.000Z'))
        self.assertTrue(interval('2016-08-01T23:10:59.111Z'))
        self.assertTrue(interval('P6Y5M/P9D'))
    ...
    def test_duration(self):
        self.assertTrue(duration('P3Y6M4W7DT12H30M5S'))
        self.assertTrue(duration('P6M4DT12H30M15S'))
        self.assertTrue(duration('P6M1DT'))
        self.assertTrue(duration('P6W'))
