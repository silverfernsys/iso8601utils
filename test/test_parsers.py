...
class TestParsers(unittest.TestCase):
    ...
    def test_date(self):
        ...
        self.assertEqual(date('2005-12-31'), date('2005-W52-6'))
        self.assertEqual(date('2007-01-01'), date('2007-W01-1'))
        self.assertEqual(date('2007-12-30'), date('2007-W52-7'))
        self.assertEqual(date('2007-12-31'), date('2008-W01-1'))
        self.assertEqual(date('2008-01-01'), date('2008-W01-2'))
        self.assertEqual(date('2008-12-28'), date('2008-W52-7'))
        self.assertEqual(date('2008-12-29'), date('2009-W01-1'))
        self.assertEqual(date('2008-12-30'), date('2009-W01-2'))
        self.assertEqual(date('2008-12-31'), date('2009-W01-3'))
        self.assertEqual(date('2009-01-01'), date('2009-W01-4'))
        self.assertEqual(date('2009-12-31'), date('2009-W53-4'))
        self.assertEqual(date('2010-01-01'), date('2009-W53-5'))
        self.assertEqual(date('2010-01-02'), date('2009-W53-6'))
        self.assertEqual(date('2010-01-03'), date('2009-W53-7'))
        ...
        self.assertEqual(date('2015-W30-4'), date_(2015, 7, 23))
        self.assertEqual(date('1981-095'), date_(1981, 4, 5))
        self.assertEqual(date('1981095'), date_(1981, 4, 5))
        self.assertEqual(date('1981-04-05'), date_(1981, 4, 5))
        self.assertEqual(date('19810405'), date_(1981, 4, 5))
        self.assertEqual(date('--04-03'), date_(1, 4, 3))
    ...
    def test_interval(self):
        ...
        self.assertRaises(ValueError, interval, '1999-12-01T00:00:0a/1999-12-31T16:00:00.000Z')
        self.assertRaises(ValueError, interval, 'A4/1999-12-01T00:00:00/1999-12-31T16:00:00.000Z')
